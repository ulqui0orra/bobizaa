...
let handler = async (m, { conn, command, args }) => {
  ...
  if (m.quoted && m.quoted.mtype) {
    ...
    throw "هذا الامر من خلاله يمكنك ان تنشر استوري في الواتس بدون الخروج من المحاذثة كيف ذلك ? سوف ترسل للبوت الخاص بك الصورة او الفيديو او الأديو الذي تريد ان تنشره في الواتساب بدون الخروج من المحاذثة ثم تشير له وتكتب \n\n*.حاله*";
  }
};
