...
—◉ *إذا كنت تعتقد أن هذا خطأ ولديك دليل، فيمكنك الاتصال بمالك الروبوت لاستئناف التعليق.* —◉ *التواصل مع مالكه:* wa.me/201225188065
╚═════════════════════╝
               `.trim();
              m.reply(messageText);
...
global.dfail = (type, m, conn) => {
  const msg = {
    ...
    unreg: '*[ ℹ️ ] لاستخدام هذا الأمر يجب عليك التسجيل.*\n\n*[ 💡 ] استخدم هذا الامر:* _#verify name.age_ *to register.*',
    restrict: '*[ ℹ️ ] تم تعطيل هذا الأمر من قبل مالك الروبوت.*',
  }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Warning*', body: 'Ulquiorra', thumbnail: imagen1, sourceUrl: 'https://instagram.com/noureddine_ouafy'}}}}, aa);
